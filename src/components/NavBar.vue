        ...
        <div class="flex w-full sm:justify-between justify-center">
          <router-link :to="{ name: 'home' }">
            <i class="block h-8 w-auto lg:hidden">
              <svg class="stroke-accent hover:stroke-semantic stroke-1 hover:cursor-pointer transition-all duration-300 transform ease" width="33" height="33" viewBox="0 0 66 66"
