      ...
      <div class="relative flex h-16 items-center justify-between">
        ...
        <div class="flex w-full sm:justify-between justify-center">
          <router-link :to="{ name: 'home' }">
            ...
            <i class="hidden h-8 w-auto lg:block" src="/icon.svg" alt="Maria Bladé">
              <svg
          ...
          <div class="hidden sm:ml-6 sm:block">
            <div class="flex space-x-4">
              <router-link 
              v-for="item in navigation" :to="{ name: item.to }"
...
const closeMenuIfClickedOutside = (event) => {
  const menu = document.querySelector('.navBar-underline')
  const menuButton = document.querySelector('button')
  if (menu && !menu.contains(event.target) && !menuButton.contains(event.target) && menuOpen.value) {
...
// Remove the event listener before component is unmounted
onBeforeUnmount(() => {
