...
<template>
        <main class="h-[600px] lg:px-16 sm:px-8 px-4 font-display">
            <section
                class="flex justify-around flex-col mx-auto h-full text-center text-3xl sm:text-4xl lg:text-6xl">
                <article> <span class="hola-container">Hola! </span> </article> <article>My name <span class="name-container py-7 lg:py-10">is MARIA
                        BLADÉ</span> !!!!!!!!
                </article>
                <article class="mt-6 text-center text-3xl sm:text-4xl lg:text-6xl">
                    I'm an <span class="interaction-container py-3"> interaction designer </span> and <span
                        class="frontend-container py-1"> front-end developer</span> based in Barcelona.
                </article>
                <article class="mx-auto max-w-sm sm:items-end items-center text-center flex flex-col sm:flex-row sm:max-w-none">
                    ...
                    <div class="flex flex-col mt-2 sm:mt-0">
                        <div class="flex gap-3 justify-center sm:justify-start">
                            ...
                            <a href="https://github.com/bleidbleid" class="text-center text-xl lg:text-3xl">
                                github.com/bleidbleid
                            </a>
                        </div>
                        <div class="flex gap-3 content-start justify-center mt-2 sm:mt-0">
                            <img class="hidden sm:block" src="/email-arrow.svg" alt="">
                            <h1 class="text-center text-xl lg:text-3xl">
